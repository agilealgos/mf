		...
		public function plugins_loaded() {
			if ( ( ! is_admin() || defined( 'DOING_AJAX' ) ) && allow_reward_points_for_user( get_current_user_id() ) ) {
				...
				foreach ( $ModulesId as $filename ) {
					$ModuleToExclude = array( 'fpcoupon' , 'fpsendpoints' , 'fppointexpiry' , 'fpreset' , 'fpreportsincsv' , 'fpimportexport' , 'fpemailexpiredpoints' ,'fpbonuspoints','fpanniversarypoints','fppromotional') ;
