...
if ( ! class_exists( 'RSBirthdayPoints' ) ) {
	...
	class RSBirthdayPoints {
		...
		public static function settings_option() {
						 ...
						 * @since 1.0
						 */
			return apply_filters( 'woocommerce_fpbirthday_settings' , array(
				array(
				...
				array( 'type' => 'sectionend' , 'id' => '_rs_activate_birthday_module' ) ,
				array(
				...
				array( 'type' => 'sectionend' , 'id' => '_rs_birthday_setting' ) ,
				array(
					'type' => 'rs_wrapper_end' ,
				) ,
							array(
				...
				array( 'type' => 'sectionend' , 'id' => 'rs_bday_field_settings' ) ,
				array(
					'type' => 'rs_wrapper_end' ,
				) ,
				array(
				...
				array(
					...
					'std'     => 'Birthday Reward Points - Notification' ,
				...
				array(
					...
					'std'     => 'You have earned [rs_birthday_points] points for your Birthday. Currently, you have [rs_available_points] points in your account.' ,
					'default' => 'You have earned [rs_birthday_points] points for your Birthday. Currently, you have [rs_available_points] points in your account.' ,
					'type'    => 'textarea' ,
					'newids'  => 'rs_email_message_for_bday_points' ,
				) ,
				array( 'type' => 'sectionend' , 'id' => '_rs_bday_email_settings' ) ,
				array(
					'type' => 'rs_wrapper_end' ,
				) ,
								array(
				...
				array( 'type' => 'sectionend' , 'id' => 'rs_bday_details' ) ,
				array(
					'type' => 'rs_wrapper_end' ,
				) ,
					) ) ;
