...
<br><br>
<b>Note:</b>
Earning Points Conversion Settings given in the General Settings will consider only when you choose the Reward Type as Percentage of Product Price.' , 'rewardsystem' ) ,
			...
			array(
				...
				array(
					...
					'desc_tip' => true ,
					'options'  => array( 'minutes' => __('Minutes', 'rewardsystem') , 'hours' => __('Hours', 'rewardsystem') , 'days' => __('Days', 'rewardsystem') ) ,
					'std'      => 'days' ,
					'default'  => 'days' ,
				) ,
				array(
