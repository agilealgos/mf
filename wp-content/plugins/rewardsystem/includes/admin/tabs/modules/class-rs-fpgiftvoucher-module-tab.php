...
if ( ! class_exists( 'RSGiftVoucher' ) ) {
	...
	class RSGiftVoucher {
		...
		public static function reward_system_admin_fields() {
						/**
						 * Hook:woocommerce_fpgiftvoucher_settings.
						 * 
						 * @since 1.0
						 */
			return apply_filters( 'woocommerce_fpgiftvoucher_settings' , array(
				...
				array(
					'name' => __( 'Shortcode used in Gift Voucher' , 'rewardsystem' ) ,
					'type' => 'title' ,
		...
		public static function table_to_display_created_voucher_codes() {
			...
			if ( isset( $_REQUEST[ 'rs_export_reward_codes_csv' ] ) ) {
				...
				header( 'Expires: 0' ) ;
								echo wp_kses_post('Voucher Code,Points,Created on,Expires on,Voucher Code used by' . "\n") ;
