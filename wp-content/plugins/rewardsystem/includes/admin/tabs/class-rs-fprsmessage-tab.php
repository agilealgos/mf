	...
	class RSMessage {
		...
		public static function reward_system_admin_fields() {
			...
			return apply_filters( 'woocommerce_fprsmessage_settings' , array(
				...
				array(
					'name'    => __( 'Number of Page Size in My Reward Table' , 'rewardsystem' ) ,
			...
			<table class="form-table fp-srp-points-log">
				...
				<tbody class="sortable">
					...
					foreach ( $SortedColumn as $Column ) {
						?>
						<tr>
							<th class="post_sort_handle"><?php echo wp_kses_post($Labels[ $Column ] ); ?></th>
							<td class="post_sort_handle">
								<input type="hidden" name="sorted_list[<?php echo esc_attr($Column) ; ?>]" value="<?php echo wp_kses_post($Column); ?>">
