...
if ( ! class_exists( 'SRP_Admin_Enqueue' ) ) {
	...
	class SRP_Admin_Enqueue {
		...
		public static function external_css_files() {
			...
			wp_enqueue_style( 'fp-srp-admin' , SRP_PLUGIN_URL . '/assets/css/admin.css' , array() , SRP_VERSION ) ;
			wp_enqueue_style( 'fp-srp-welcome-page' , SRP_PLUGIN_URL . '/assets/css/fp-srp-welcome-page.css' , array() , SRP_VERSION ) ;
		...
		public static function enqueue_for_promotional_modules_tab() {
			...
			wp_localize_script( 'fp_promotional_module' , 'fp_promotional_params' , array(
			'ajaxurl'           => SRP_ADMIN_AJAX_URL ,
