...
if ( ! class_exists( 'Anniversary_Points_Handler' ) ) {
	...
	class Anniversary_Points_Handler {
		 ...
		 */
		public static function validate_rule_based_account_anniversary_rule( $user_id,
				$settings_rule_key, $settings_rule_value ) {
		 ...
		 */
		public static function award_one_time_account_anniversary_points( $user_id,
				$user ) {
		 ...
		 */
		public static function award_every_year_account_anniversary_points( $user_id,
				$user ) {
		 ...
		 */
		public static function award_rule_based_account_anniversary_points( $user_id,
				$user, $rule_value ) {
		 ...
		 */
		public static function insert_anniversary_points( $user_id, $event_slug,
				$point_value ) {
		 ...
		 */
		public static function validate_multiple_anniversary_rule( $user_id,
				$settings_rule_key, $settings_rule_value ) {
		 ...
		 *  Add anniversary points on page load.
		 */
		public static function add_anniversary_points_on_page_load( $user_name,
				$user ) {
		 ...
		 * May be add meta after points recorded.
		 */
		public static function may_be_add_meta_after_points_recorded( $user_id,
				$earned_points, $usedpoints, $earned_time, $table_args ) {
