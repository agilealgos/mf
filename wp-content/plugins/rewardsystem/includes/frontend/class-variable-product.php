			...
			if ( 'yes' == get_option( 'rs_enable_display_earn_message_for_variation_single_product' ) ) {
				...
				if ( srp_check_is_array( $variationid ) ) {
					...
					if ( '' != $varpointss ) {
						...
						$messages     = is_user_logged_in() ? get_option( 'rs_message_for_single_product_variation' ) : get_option( 'rs_earn_message_single_product_variation_guest' , 'Earn [variationrewardpoints] Reward Points') ;
				...
				if ( 'yes' == get_option( 'rs_enable_display_earn_message_for_variation_single_product' ) ) {
					if ( ( '' != $earnmessages || '' != $earnmessage ) ) {
											$localised_script_args = array(
												...
												'show_or_hide_purchase_message' => is_user_logged_in() ? get_option( 'rs_show_hide_message_for_variable_product' ) :get_option( 'rs_show_hide_message_variation_single_product_guest' ),
