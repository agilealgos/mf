		...
		\CSF::createSection( $prefix, array(
			'fields' => array(
				...
				array(
					'id'      => 'what_to_show',
					'type'    => 'select',
					'title'   => __( 'Show Icon or Name', 'bp-custom-order-status' ),
				...
				array(
					...
					'dependency' => array( 'what_to_show', '==', 'icon' ),
				),
				array(
					'id'      => 'text_color',
					'default' => '#000000',
				...
				array(
					'id'      => 'is_status_paid',
					'type'    => 'checkbox',
					'title'   => __( 'It is a paid Status', 'bp-custom-order-status' ),
					'label'   => __( 'Check if order on this status has been Paid', 'bp-custom-order-status' ),
					'default' => '0',
				),
				array(
					'id'      => 'downloadable_grant',
					'type'    => 'checkbox',
					'title'   => __( 'Grant access to downloadable products', 'bp-custom-order-status' ),
					'label'   => __( 'Enable this option to grant access to downloads when orders are on this status', 'bp-custom-order-status' ),
					'default' => '0',
				),
				array(
					...
					'label'   => __( 'Add to actions', 'bp-custom-order-status' ),
					'default' => '0',
				),
				array(
					'id'      => '_enable_bulk',
					...
					'label'   => __( 'Check this to add this order status to the Orders list table Bulk Actions list.', 'bp-custom-order-status' ),
					'default' => '0',
				),
				array(
					'id'    => '_enable_email',
					'type'  => 'checkbox',
					'title' => __( 'Enable Email Notification', 'bp-custom-order-status' ),
					'label' => __( 'Check this if you want notify by email when order status change to this status', 'bp-custom-order-status' ),
