...
$plugins=array(
    ...
    'pdf_invoices_plugin' => array(
        'title'         => __('WooCommerce PDF Invoices, Packing Slips, Delivery Notes and Shipping Labels', 'users-customers-import-export-for-wp-woocommerce'),
        'description'   => __('Generate, customize, and manage WooCommerce documents including PDF invoices, packing slips, delivery notes, shipping labels, address labels, and other shipping documents using a single plugin.', 'users-customers-import-export-for-wp-woocommerce'),
