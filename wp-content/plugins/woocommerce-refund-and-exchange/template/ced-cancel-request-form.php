		...
		<div class="<?php echo $ced_child_wrapper_class; ?>" id="ced_rnx_return_request_form_wrapper">
			...
			<div class="ced_rnx_product_table_wrapper" >
				<table class="shop_table order_details ced_rnx_product_table">
					<thead>
						<tr>
							<th class="product-check"><input type="checkbox" name="ced_rnx_cancel_product_all" class="ced_rnx_cancel_product_all" value="<?php echo esc_html( $order_id ); ?>"><?php _e( 'Check All', 'woocommerce-refund-and-exchange' ); ?></th>
