...
if ( $ced_rnx_license_hash == $ced_rnx_hash || $ced_rnx_days_left >= 0 ) {
	...
	<div class="wrap ced_rnx_notification">
		...
		<nav class="nav-tab-wrapper woo-nav-tab-wrapper">
			...
			<a class="nav-tab <?php echo $ced_rnx_addon_section; ?>" href="<?php echo admin_url(); ?>admin.php?page=ced-rnx-notification&amp;tab=ced_rnx_addon_section"><?php _e( 'RAE Add-Ons', 'woocommerce-refund-and-exchange' ); ?></a>
			<?php
									...
									<td class="titledesc" scope="row" colspan="2">
										<div id="ced_rnx_return_predefined_reason_wrapper">
											...
											if ( isset( $predefined_return_reason ) && ! empty( $predefined_return_reason ) ) {
												foreach ( $predefined_return_reason as $return_key => $predefine_reason ) {
													if ( isset( $predefine_reason ) && ! empty( $predefine_reason ) ) {
														?>
														<div class="ced_rnx_return_reason_section">
															<input type="text" class="input-text ced_rnx_return_predefined_reason" value="<?php echo $predefine_reason; ?>" class="ced_rnx_return_predefined_reason" name="ced_rnx_return_predefined_reason[]">
															<?php if ( $return_key != 0 ) { ?>
															<a  href="#" class="ced_rnx_remove_return"><?php _e( 'Remove', 'woocommerce-refund-and-exchange' ); ?></a>
														<?php } ?>
														</div>
														<?php
													} else {
												...
												?>
												<div class="ced_rnx_return_reason_section">
													<input type="text" class="input-text ced_rnx_return_predefined_reason" class="ced_rnx_return_predefined_reason" name="ced_rnx_return_predefined_reason[]">
												</div>
												<?php
											}
											?>
											...
											if ( isset( $predefined_exchange_reason ) && ! empty( $predefined_exchange_reason ) ) {
												foreach ( $predefined_exchange_reason as $ex_key => $predefine_reason ) {
													if ( ! empty( $predefine_reason ) ) {
														?>
														<div class="ced_rnx_exchange_reason_section">
															<input type="text" class="input-text ced_rnx_exchange_predefined_reason" value="<?php echo $predefine_reason; ?>" class="ced_rnx_exchange_predefined_reason" name="ced_rnx_exchange_predefined_reason[]">
															<?php if ( $ex_key != 0 ) { ?>
																<a href="#" class="remove_exchange_reason"><?php _e( 'Remove', 'woocommerce-refund-and-exchange' ); ?></a>
															<?php } ?>
														</div>
														<?php
													} else {
												...
												?>
													<input type="text" class="input-text ced_rnx_exchange_predefined_reason" class="ced_rnx_exchange_predefined_reason" name="ced_rnx_exchange_predefined_reason[]">
												<?php
											}
											?>
										</div>
						...
						<table class="form-table ced_rnx_notification_section">
							<tbody>
								<tr valign="top">
									...
									<td>
										<span class="ced_rnx_checkbox_wrrapper">
											<input type="checkbox" id="ced_rnx_enable_price_policy" name="ced_rnx_enable_price_policy" 
											<?php
								...
								<tr valign="top">
									...
									<td>
										<span class="ced_rnx_checkbox_wrrapper">
											<input type="checkbox" id="ced_rnx_show_refund_policy_on_product_page" name="ced_rnx_show_refund_policy_on_product_page" 
											<?php
										...
										<span class="description"><?php _e( 'Enable to add Refund policy tab in the product page. Also, you can use <strong>[ced_rnx_refund_policy]</strong> shortcode for show Refund Policy Table.', 'woocommerce-refund-and-exchange' ); ?></span>
									</td>
								</tr>
							</tbody>
						</table>
						<table class="form-table ced_rnx_notification_section" id="ced_rnx_price_based_policy">
							<tbody>
								<tr valign="top">
									...
									<th class="titledesc" scope="row">
										<label for="ced_rnx_notification_from_name"><?php _e( 'Percentage Price Reduced', 'woocommerce-refund-and-exchange' ); ?></label>
									</th>
									<th class="titledesc" scope="row">
						...
						<table class="form-table ced_rnx_notification_section">
							<tbody>
								<tr valign="top">
									...
									<td>
										<span class="ced_rnx_checkbox_wrrapper">
											<input type="checkbox" id="ced_rnx_enable_time_policy" name="ced_rnx_enable_time_policy" 
											<?php
		...
		if ( $tab == 'refund' ) {
			...
			">
					...
					<div id="ced_rnx_accordion">
						<div class="ced_rnx_accord_sec_wrap">
							...
							<div class="ced_rnx_content_sec ced_rnx_notification_section">
								<p><h3><?php _e( "These are ordered shortcodes that you can use in EMAIL MESSAGES. It will be changed with order's dynamic values.", 'woocommerce-refund-and-exchange' ); ?></h3></p>
								<p><?php echo sprintf( __( '%1$s Note :%2$s Use %3$s [order] %4$s for Order Number, %5$s [siteurl] %6$s for home page url and %7$s [username] %8$s for user name.', 'woocommerce-refund-and-exchange' ), '<b>', '</b>', '<b>', '</b>', '<b>', '</b>', '<b>', '</b>' ); ?></p>
									...
									<tbody>
										...
										<tr valign="top">
											...
											<td class="forminp forminp-textarea">
												...
												<span class="ced_rnx_checkbox_wrrapper">
													<input type="checkbox" id="ced_rnx_notification_auto_accept_return_template" name="ced_rnx_notification_auto_accept_return_template" 
													<?php
													if ( $ced_rnx_notification_auto_accept_return_template == 'on' ) {
														?>
														checked="checked"
														<?php
													}
												...
												<?php _e( 'Enable, if you want to put custom email template in editor & Put your email template under text tab of the editor. ', 'woocommerce-refund-and-exchange' ); ?>
											</td>
										</tr>
										<tr valign="top">
											<th class="titledesc" scope="row">
									...
									<tbody>
										...
										<tr valign="top">
											...
											<td class="forminp forminp-textarea">
												...
												<span class="ced_rnx_checkbox_wrrapper">
													<input type="checkbox" id="ced_rnx_notification_return_template" name="ced_rnx_notification_return_template" 
													<?php
													if ( $ced_rnx_notification_return_template == 'on' ) {
														?>
														checked="checked"
														<?php
													}
										...
										<tr valign="top">
											<th class="titledesc" scope="row">
												<label for="ced_rnx_notification_return_rcv"><?php _e( 'Received Refund Request Message', 'woocommerce-refund-and-exchange' ); ?></label>
											</th>
											<td class="forminp forminp-textarea">
												<?php
									...
									<tbody>
										...
										<tr valign="top">
											...
											<td class="forminp forminp-textarea">
												...
												<span class="ced_rnx_checkbox_wrrapper">
													<input type="checkbox" id="ced_rnx_notification_return_approve_template" name="ced_rnx_notification_return_approve_template" 
													<?php
													if ( $ced_rnx_notification_return_approve_template == 'on' ) {
														?>
														checked="checked"
														<?php
													}
										...
										<tr valign="top">
											...
											<td class="forminp forminp-textarea">
												...
												<span class="ced_rnx_checkbox_wrrapper">
													<input type="checkbox" id="ced_rnx_notification_return_approve_wallet_template" name="ced_rnx_notification_return_approve_wallet_template" 
													<?php
													if ( $ced_rnx_notification_return_approve_wallet_template == 'on' ) {
														?>
														checked="checked"
														<?php
													}
								...
								<table class="form-table ced_rnx_notification_section ">
									...
									<tr valign="top">
										...
										<td class="forminp forminp-textarea">
											...
											<span class="ced_rnx_checkbox_wrrapper">
												<input type="checkbox" id="ced_rnx_notification_return_approve_wallet_template" name="ced_rnx_notification_return_cancel_template" 
												<?php
												if ( $ced_rnx_notification_return_cancel_template == 'on' ) {
													?>
													checked="checked"
													<?php
												}
				...
				<p class="submit">
					...
					?>
												" class="ced-rnx-save-button button-primary woocommerce-save-button" name="ced_rnx_noti_save_return"> 
				</p>
			</form>
		</div>
			<?php
			...
			<form enctype="multipart/form-data" action="" id="mainform" method="post">
				<div id="ced_rnx_accordion">
					<div class="ced_rnx_accord_sec_wrap">
						<h2><?php _e( 'Short-Codes ', 'woocommerce-refund-and-exchange' ); ?></h2>
						<div class="ced_rnx_content_sec ced_rnx_notification_section">
							<p><?php _e( 'These are ordered shortcodes that you can use in EMAIL MESSAGE', 'woocommerce-refund-and-exchange' ); ?></p>
							<p><?php echo sprintf( __( '%1$s Note :%2$s Use %3$s [order] %4$s for Order Number, %5$s [siteurl] %6$s for home page url and %7$s [username] %8$s for user name.', 'woocommerce-refund-and-exchange' ), '<b>', '</b>', '<b>', '</b>', '<b>', '</b>', '<b>', '</b>' ); ?></p>
							<p><?php echo '<strong> [_order_total] , [formatted_shipping_address] , [formatted_billing_address] , [_billing_company] , [_billing_email] , [_billing_phone] , [_billing_country] , [_billing_address_1] , [_billing_address_2] , [_billing_state] , [_billing_postcode] , [_shipping_first_name] , [_shipping_last_name] , [_shipping_company] , [_shipping_country] , [_shipping_address_1] , [_shipping_address_2] , [_shipping_city] , [_shipping_state] , [_shipping_postcode] , [_payment_method_tittle] , [_order_shipping] , [new_order_id_created] , [new_order_typ_url]</strong>'; ?></p>
								...
								<tbody>
									...
									<tr valign="top">
										...
										<td class="forminp forminp-textarea">
											...
											<span class="ced_rnx_checkbox_wrrapper">
												<input type="checkbox" id="ced_notification_exchange_template" name="ced_notification_exchange_template" 
												<?php
												if ( $ced_notification_exchange_template == 'on' ) {
													?>
													checked="checked"
													<?php
												}
								...
								<tbody>	
									...
									<tr valign="top">
										...
										<td class="forminp forminp-textarea">
											...
											<span class="ced_rnx_checkbox_wrrapper">
												<input type="checkbox" id="ced_rnx_notification_exchange_approve_template" name="ced_rnx_notification_exchange_approve_template" 
												<?php
												if ( $ced_rnx_notification_exchange_approve_template == 'on' ) {
													?>
													checked="checked"
													<?php
												}
								...
								<tbody>
									...
									<tr valign="top">
										...
										<td class="forminp forminp-textarea">
											...
											<span class="ced_rnx_checkbox_wrrapper">
												<input type="checkbox" id="ced_rnx_notification_exchange_cancel_template" name="ced_rnx_notification_exchange_cancel_template" 
												<?php
												if ( $ced_rnx_notification_exchange_cancel_template == 'on' ) {
													?>
													checked="checked"
													<?php
												}
							...
							<table class="form-table ced_rnx_notification_section">
								<tr valign="top">
									...
									<td class="forminp forminp-textarea">
										...
										?>
										<span class="ced_rnx_checkbox_wrrapper">
											<input type="checkbox" id="ced_rnx_enable_return_ship_label" name="ced_rnx_enable_return_ship_label"
											<?php
								...
								<tr valign="top">
									...
									<td class="forminp forminp-textarea">
										<p><?php _e( ' Use ', 'woocommerce-refund-and-exchange' ); ?><b>[Tracking_Id]</b><?php _e( ' Shortcode in Place of Tracking Id. Here tracking id represents order Id.', 'woocommerce-refund-and-exchange' ); ?>
								...
								<table class="form-table ced_rnx_notification_section">
									<tr>
										<td><br>
											<?php
											_e(
												'<b>1-</b> You need to create a terms & Condition page and put your all terms and conditions as content of page. <a href="' . home_url() . '/wp-admin/post-new.php?post_type=page">Click Here</a> to create terms & conditions Page.<br><br>
											<b>2-</b> After page setup you need to go with Appearance->Customize->WooCommerce->Checkout and select terms and conditions page under Terms and conditions setting to start terms & conditions Policy.',
												'woocommerce-refund-and-exchange'
											);
											?>
										</td>
