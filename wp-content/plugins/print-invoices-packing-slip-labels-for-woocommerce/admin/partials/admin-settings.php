...
$tab_items['wf-other-solutions'] = __('Other Solutions', 'print-invoices-packing-slip-labels-for-woocommerce');
$main_module_base = "";
$main_module_id = "";
...
<div class="wt_wrap">
    ...
    <div class="wf_settings_right">
        <?php require_once($wf_admin_view_path."goto-pro.php"); ?>
        <?php require_once($wf_admin_view_path."freevspro_sidebar.php"); ?>
    </div>
</div>