                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a target="_blank"
                                                   ...
                                                   href="<?php echo esc_url( $product_url ) ?>"><?php esc_html_e( $this->settings->get_params( 'followup_email', 'review_button', $language ) ) ?>
                                                </a>
                                            </td>
                                        </tr>
										<?php
        ...
        <div id="kt_status_page" class="wrap">
            ...
            <table width="30%">
                ...
                <tr>
                    ...
                    <td><?php echo esc_html__( ini_get( 'upload_max_filesize' ), 'woocommerce-photo-reviews' ); ?></td>
                ...
                <tr>
                    ...
                    <td><?php if ( ini_get( 'post_max_size' ) > ( absint( ini_get( 'upload_max_filesize' ) ) * ini_get( 'max_file_uploads' ) + 1 ) && ini_get( 'upload_max_filesize' ) > 0 && ini_get( 'max_file_uploads' ) > 0 ) {
							echo wp_kses_post( '<span class="status-ok">OK</span>' );
						} else {
							echo wp_kses_post( '<span class="status-bad">X</span>' );
						} ?></td>
                </tr>
                <tr>
                ...
                <div class="content">
                    <div class="vi-ui positive message">
                        <ul class="list">
                            ...
                            <li><?php echo wp_kses_post( __( 'To manually send a review reminder, please go to <a target="_blank" href="' . admin_url( "edit.php" ) . '?post_type=shop_order">Orders</a>.', 'woocommerce-photo-reviews' ) ) ?></li>
            ...
            <form action="" method="post" class="vi-ui form">
                ...
                <div class="vi-ui bottom active tab segment" data-tab="general">
                    <table class="form-table">
                        ...
                        <tr>
                            <td colspan="2">
                                <p class="description"><?php echo wp_kses_post( __( 'In photos prefix, you can use <strong>{comment_id}</strong> for ID of review that a photo belongs to and <strong>{product_id}</strong> for ID of product that a review belongs to', 'woocommerce-photo-reviews' ) ); ?></p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="wcpr_reviews_anchor_link" id="wcpr-reviews-anchor-link"
                                           value="<?php echo esc_attr( htmlentities( $this->settings->get_params( 'reviews_anchor_link' ) ) ) ?>">
                            ...
                            <tr>
                                ...
                                <td>
									...
									?>
                                    <select class="vi-ui fluid dropdown restrict_number_of_reviews-option"
                                            id="restrict_number_of_reviews"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="vi-ui toggle checkbox">
                                        <input type="hidden" name="ajax_check_content_reviews"
                                               value="<?php echo esc_attr( $ajax_check_content_reviews = $this->settings->get_params( 'ajax_check_content_reviews' ) ); ?>">
                                        <input type="checkbox"
                                               id="ajax_check_content_reviews" <?php checked( $ajax_check_content_reviews, '1' ) ?>>
                            ...
                            <tr>
                                ...
                                <td>
									...
									?>
                                    <select name="wcpr_hide_name" id="wcpr_hide_name"
                                            class="wcpr_hide_name vi-ui fluid dropdown">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="wcpr-verified-badge-wrap-wrap"
                                                ...
                                                <input type="hidden" name="verified_badge"
                                                       value="<?php echo esc_attr( $this->settings->get_params( 'photo', 'verified_badge' ) ); ?>">
												<?php
...
//			'email_template'                 => isset( $_POST['email_template'] ) ? sanitize_text_field( $_POST['email_template'] ) : '',
			...
			'share_reviews'                  => isset( $_POST['share_reviews'] ) ? array_values( villatheme_sanitize_fields( $_POST['share_reviews'] ) ) : array(),
		);
...
//				}
	...
	public function wcpr_update_comment_meta() {
		if ( ! empty( $_POST['page'] ) ) {
			...
			if ( ! empty( $_POST['end'] ) ) {
				update_option( 'wcpr_comment_meta_updated', true, 'no' );
			}
