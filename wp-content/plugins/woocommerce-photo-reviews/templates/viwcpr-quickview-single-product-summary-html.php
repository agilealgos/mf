        ...
        <div class="shortcode-wcpr-single-product-summary-content-container" style="border-top: 1px solid;">
            <div class="shortcode-wcpr-single-product-summary-content">
				...
				if ( $product->get_image_id() ) {
					printf( '<div class="shortcode-wcpr-single-product-summary-image"><img src = "%s" ></div>', esc_url( wp_get_attachment_thumb_url( $product->get_image_id() ) ) );
				}
				?>
                <div class="shortcode-wcpr-single-product-summary-meta">
                    <div class="shortcode-wcpr-single-product-summary-meta-title">
                        <a href="<?php echo esc_url( $product->get_permalink() ); ?>"
                           target="_blank"><?php echo wp_kses_post( $product->get_title() ); ?></a>
                    </div>
