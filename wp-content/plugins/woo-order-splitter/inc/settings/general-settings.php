    ...
    <select name="wc_os_general_settings[wc_os_auto_clone_status]" id="wc_os_auto_clone_status">
        ...
        <li>
            ...
            <ul>      
                ...
                <li <?php echo (array_key_exists('wc_os_reduce_stock', $wc_os_general_settings)?'class="selected"':''); ?> title="<?php _e("This option will work better if items are completely moved to child orders not partially as quantity split does",'woo-order-splitter'); ?>">
                ...
                <li <?php echo (array_key_exists('wc_os_tax_cost', $wc_os_general_settings)?'class="selected"':''); ?> title="<?php _e("Cloning of tax details from Parent Order",'woo-order-splitter'); ?>">
...
<?php _e('Consolidated/Merged/Combined orders should be removed after action.', 'woo-order-splitter'); ?> - <a href="https://www.youtube.com/embed/qrZMZAuv-VU" target="_blank"><?php echo __('Watch Tutorial', 'woo-order-splitter'); ?> <i class="fab fa-youtube"></i></a></td>
