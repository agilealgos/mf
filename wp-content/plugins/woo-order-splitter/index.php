...
//    error_reporting(E_ALL);
	...
	if ( 
		...
		global $wc_os_url, $wc_os_data, $wc_os_pro, $wc_os_activated, $wc_os_premium_copy, $yith_pre_order, $wc_os_bulk_instantiated,
		...
		$wc_os_tax_cost = array_key_exists('wc_os_tax_cost', $wc_os_general_settings);
