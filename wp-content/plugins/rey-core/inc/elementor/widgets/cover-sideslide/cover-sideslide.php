...
class CoverSideslide extends \ReyCore\Elementor\WidgetsBase {
	...
	public function rey_get_script_depends() {
		return [ 'rey-videos', 'animejs', 'rey-splide', 'reycore-widget-cover-sideslide-scripts' ];
	}
	 ...
	 */
		...
		$this->add_responsive_control(
			'slider__margin_size',
			[
				'label' => esc_html__( 'Bottom / Right edge size', 'rey-core' ) . ' (px)',
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => 80,
				'min' => 0,
				'max' => 1000,
		...
		$this->add_responsive_control(
			'slider__top_margin',
			[
				'label' => esc_html__( 'Top edge size', 'rey-core' ) . ' (px)',
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => '',
				'min' => 0,
				'max' => 1000,
				'step' => 0,
				'selectors' => [
					'{{WRAPPER}} .rey-coverSideSlide' => '--header-default--height: {{VALUE}}px',
				],
				'render_type' => 'template',
				'separator' => 'after'
			]
	...
	protected function render() {
		...
		reyCoreAssets()->add_styles(['reycore-widget-cover-sideslide-styles', 'rey-splide']);
