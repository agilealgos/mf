...
class NewsletterSendinblue extends \ReyCore\Elementor\WidgetsBase {
	...
	public static function get_rey_config(){
		return [
			...
			'title' => __( 'Newsletter for Sendinblue', 'rey-core' ),
			'icon' => 'eicon-email-field',
			'categories' => [ 'rey-theme' ],
			'keywords' => ['newsletter', 'mailing list', 'sendinblue'],
			'css' => [
	...
	protected function render() {
		...
		reyCoreAssets()->add_styles(['reycore-widget-newsletter-sendinblue-styles']);
