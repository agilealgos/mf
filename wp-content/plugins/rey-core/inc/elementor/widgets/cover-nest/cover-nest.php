...
class CoverNest extends \ReyCore\Elementor\WidgetsBase {
	...
	public function __construct( $data = [], $args = null ) {
		...
		if( ! empty($data) ):
			...
			if( isset($data['settings']['entrance_animation']) && $data['settings']['entrance_animation'] === '' ){
				add_filter('body_class', function($classes){
					$classes['activate_nest'] = '--cNest-active';
	...
	public function rey_get_script_depends() {
		return [ 'animejs', 'rey-splide', 'reycore-widget-cover-nest-scripts' ];
	}
	 ...
	 */
		...
		$this->add_control(
			'mobile_height',
			[
				'label' => esc_html__( 'Custom Height - Mobile', 'rey-core' ) . ' (px)',
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => '',
				'min' => 50,
				'max' => 1000,
	...
	protected function render() {
		...
		reyCoreAssets()->add_styles(['reycore-widget-cover-nest-styles', 'rey-splide']);
