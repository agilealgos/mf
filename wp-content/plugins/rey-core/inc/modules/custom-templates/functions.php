...
add_filter( 'reycore/ajaxfilters/js_params', function ($params){
	...
	if( isset($params['shop_loop_container']) ){
		$params['shop_loop_container'] = $params['shop_loop_container'] . ', .elementor-widget-reycore-woo-loop-products .reyajfilter-before-products';
	}
	if( isset($params['not_found_container']) ){
		$params['not_found_container'] = $params['not_found_container'] . ', .elementor-widget-reycore-woo-loop-products .reyajfilter-before-products';
	}
