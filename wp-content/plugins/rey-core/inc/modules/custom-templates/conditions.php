...
class Conditions
{
	...
	private function get_template_type__archive( $items ){
		...
		foreach ($items as $template) {
			...
			if( $archive_conditions = $template['archive_conditions']){
	...
	private function get_template_type__product( $items ){
		...
		foreach ($items as $template) {
			...
			if( $product_conditions = $template['product_conditions'] ){
	...
	private function get_template_type__product_archive( $items ){
		...
		foreach ($items as $template) {
			...
			if( $product_archive_conditions = $template['product_archive_conditions'] ){
	...
	private function get_template_type__single( $items ){
		...
		foreach ($items as $template) {
			...
			if( $general_conditions = $template['general_conditions'] ){
