...
class Elementor
{
	...
	public function add_elementor_widget_categories( $elements_manager ) {
		...
		$categories = [
			'rey-woocommerce-pdp' => [
				'title' => sprintf(__( '%s - WooCommerce <strong>Product Page</strong>', 'rey-core' ), reycore__get_props('theme_title') ),
				'icon' => 'fa fa-plug',
			],
			'rey-woocommerce-loop' => [
				'title' => sprintf(__( '%s - WooCommerce <strong>Product Archive</strong>', 'rey-core' ), reycore__get_props('theme_title') ),
				'icon' => 'fa fa-plug',
			]
		];
