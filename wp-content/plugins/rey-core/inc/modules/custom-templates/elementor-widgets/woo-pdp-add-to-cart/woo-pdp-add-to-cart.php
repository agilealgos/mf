...
class WooPdpAddToCart extends WooBase {
			...
			$this->add_responsive_control(
				...
				[
				   'label' => esc_html__( 'Height', 'rey-core' ),
					...
					'default' => [],
					'selectors' => [
						$selectors['atc'] => '--comp-heights: {{SIZE}}{{UNIT}};',
					],
				]
			);
	...
	function render_template() {
		...
		add_filter('woocommerce_is_sold_individually',[$this, 'enable_qty'], 10, 2 );
		...
		remove_filter( 'woocommerce_is_sold_individually',[$this, 'enable_qty'], 10, 2 );
