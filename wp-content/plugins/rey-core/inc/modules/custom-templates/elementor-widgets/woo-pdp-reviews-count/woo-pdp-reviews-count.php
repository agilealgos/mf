...
class WooPdpReviewsCount extends WooBase {
	...
	protected function element_register_controls() {
		...
		$this->start_controls_section(
			...
			$selectors['stars_inactive'] = '{{WRAPPER}} .star-rating::before';
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						$selectors['stars_inactive'] => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_control(
				'active_stars_color',
				[
					'label' => esc_html__( 'Active Stars Color', 'rey-core' ),
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						$selectors['stars'] => '--star-rating-color: {{VALUE}}',
					],
				]
			);
