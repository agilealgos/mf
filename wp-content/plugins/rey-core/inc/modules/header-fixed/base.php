...
class Base extends \ReyCore\Modules\ModuleBase {
	...
	function elementor_section_fixed_header_settings( $element ){
		...
		$element->start_controls_section(
			...
			[
				'label' => __( 'Fixed/Sticky Section Settings', 'rey-core' ) . \ReyCore\Elementor\Helper::rey_badge(),
			...
			if( $this->shrink_is_enabled() ):
				...
				$element->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'.--shrank {{WRAPPER}}' => 'padding-top: {{SIZE}}px;',
						],
						'condition' => [
							'rey_hide_on_scroll' => '',
							'rey_scrolled_force_height' => '',
				...
				$element->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'.--shrank {{WRAPPER}}' => 'padding-bottom: {{SIZE}}px;',
						],
						'condition' => [
							'rey_hide_on_scroll' => '',
							'rey_scrolled_force_height' => '',
	...
	function elementor_column_fixed_header_settings( $element ){
		...
		$element->start_controls_section(
			'section_rey_fixed_header',
			[
				'label' => __( 'Fixed Header Settings', 'rey-core' )  . \ReyCore\Elementor\Helper::rey_badge(),
				'tab' => \Elementor\Controls_Manager::TAB_ADVANCED,
				'hide_in_inner' => true,
			]
		);
