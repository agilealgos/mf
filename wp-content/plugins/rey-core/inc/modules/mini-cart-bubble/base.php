...
class Base extends \ReyCore\Modules\ModuleBase {
	...
	public function add_cart_assets(){
		...
		reyCoreAssets()->add_scripts( [ 'underscore', 'wp-util', self::ASSET_HANDLE] );
	...
	public function render_markup(){
		...
		<div class="rey-crossSells-bubble --loading">
			...
			<h3 class="rey-crossSells-bubble-title"><?php echo $title ?></h3>
			<?php endif; ?>
	...
	public function add_customizer_options( $section ){
		...
		$section->add_title(  esc_html__('SIDE PRODUCTS BUBBLE', 'rey-core') );
