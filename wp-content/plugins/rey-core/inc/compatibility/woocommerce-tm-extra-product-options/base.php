...
class Base extends \ReyCore\Compatibility\CompatibilityBase
{
	...
	public function load_scripts(){
		...
		wp_enqueue_script( 'reycore-tm-epo-scripts', self::get_path( basename( __DIR__ ) ) . '/script.js', ['jquery', 'reycore-scripts', 'rey-script', 'reycore-woocommerce'], REY_CORE_VERSION, true );
	}
}
