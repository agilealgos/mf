...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_subtotal' ) ) {
	...
	function woocommerce_widget_shopping_cart_subtotal() {
		...
		printf('<div class="minicart-total-row"><div class="minicart-total-row-head">%s</div><div class="minicart-total-row-content">%s</div></div>', esc_html__( 'Subtotal:', 'woocommerce' ), WC()->cart->get_cart_subtotal());
