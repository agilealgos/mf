...
<?php endif; ?>
	...
	<div class="woocommerce-billing-fields">
		...
		<div class="woocommerce-billing-fields__field-wrapper clearfix">
			...
			<?php if( ! $billing_first ): ?>
			<input id="<?php echo apply_filters('woocommerce_ship_to_different_address_input_id', 'ship-to-different-address-checkbox'); ?>" type="hidden" name="ship_to_different_address" value="1" checked />
			<?php endif; ?>
		</div>
