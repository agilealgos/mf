                    ...
                    if($wpdb->query("DELETE FROM $wpdb->comments WHERE comment_type = 'comment'") != FALSE){
                            ...
                            .then((value) => {
                              switch (value) {
                                ...
                                case "coffee":
                                     window.open("https://ko-fi.com/navneetsoni?traget=alert", "_blank");
                                  break;
                                default:
...
<div id="wpbody" role="main">
   <div id="wpbody-content" aria-label="Main content" tabindex="0" style="overflow: hidden;">
      <div class="wrap columns-2 seed_wnb">
	     ...
	     <iframe id='kofiframe' src='https://ko-fi.com/navneetsoni/?hidefeed=true&widget=true&embed=true&preview=true' style='border:none;width:100%;padding:4px;background:#f9f9f9;' height='712' title='navneetsoni'></iframe>
