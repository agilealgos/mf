...
class Pixel_Manager
{
    ...
    private function __construct()
    {
        ...
        add_action( 'wp_head', function () {
            ...
            if ( is_user_logged_in() && Environment::is_litespeed_esi_active() ) {
                add_action( 'litespeed_esi_load-inject_data_layer_with_esi', function () {
                ...
                apply_filters( 'litespeed_esi_load-inject_data_layer_with_esi', 'inject_data_layer_with_esi' );
            } else {
                $this->inject_data_layer();
            }
         ...
         */
        if ( Shop::track_user() ) {
            add_action( 'wp_enqueue_scripts', [ $this, 'pmw_front_end_scripts' ] );
        }
    ...
    public function pmw_front_end_scripts()
    {
