...
class Admin
{
    ...
    public function add_section_advanced_subsection_google( $section_ids )
    {
        ...
        add_settings_field(
            ...
            esc_html__( 'Automatic Email Link Tracking', 'woocommerce-google-adwords-conversion-tracking-tag' ) . $this->html_beta(),
        ...
        add_settings_field(
            ...
            esc_html__( 'Automatic Phone Link Click Tracking', 'woocommerce-google-adwords-conversion-tracking-tag' ) . $this->html_beta(),
    ...
    private function get_documentation_html( $path )
    {
    ...
    public function info_html_automatic_email_link_tracking()
    {
        ...
        $this->display_status_icon( Options::is_ga4_enabled() );
    }
    ...
    public function options_validate( $input )
    {
        ...
        $input = self::validate_twitter_event( 'add_to_cart', $input, $this->options );
        $input = self::validate_twitter_event( 'add_to_wishlist', $input, $this->options );
        $input = self::validate_twitter_event( 'view_content', $input, $this->options );
        $input = self::validate_twitter_event( 'search', $input, $this->options );
        $input = self::validate_twitter_event( 'initiate_checkout', $input, $this->options );
        //		$input = self::validate_twitter_event('add_payment_info', $input, $this->options);
        $input = self::validate_twitter_event( 'purchase', $input, $this->options );
        ...
        if ( isset( $input['google']['ads']['conversion_adjustments']['conversion_name'] ) ) {
            ...
            if ( !Validations::is_valid_conversion_adjustments_conversion_name( $input['google']['ads']['conversion_adjustments']['conversion_name'] ) ) {
    ...
    private static function validate_twitter_event( $event, $input, $options )
    {
    ...
    private static function deduplication_check( $input )
    {
        ...
        if ( isset( $input['shop']['order_deduplication'] ) && !$input['shop']['order_deduplication'] ) {
     ...
     */
    private function non_form_keys( $input )
    {
        $non_form_keys = [
