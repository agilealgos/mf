	...
	public static function third_party_plugin_tweaks() {
		...
		if (self::is_real_cookie_banner_active()) {
			...
			add_action('RCB/Templates/TechnicalHandlingIntegration', function ( $integration ) {
				...
				self::handle_rcb_integration($integration, Options::is_bing_enabled(), $tag_names['bing-ads']);
				self::handle_rcb_integration($integration, Options::is_facebook_enabled(), $tag_names['facebook-ads']);
				...
				self::handle_rcb_integration($integration, Options::is_pinterest_enabled(), $tag_names['pinterest-ads']);
				self::handle_rcb_integration($integration, Options::is_snapchat_enabled(), $tag_names['snapchat-ads']);
				self::handle_rcb_integration($integration, Options::is_tiktok_enabled(), $tag_names['tiktok-ads']);
				self::handle_rcb_integration($integration, Options::is_twitter_enabled(), $tag_names['twitter-ads']);
				self::handle_rcb_integration($integration, Options::is_reddit_enabled(), $tag_names['reddit-ads']);
