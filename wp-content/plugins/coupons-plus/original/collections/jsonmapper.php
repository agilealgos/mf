...
use CouponsPlus\Original\Collections\Mapper\Mappable;
...
use CouponsPlus\Original\Collections\Mapper\Types\StringType as S;
use StdClass;
...
Class JSONMapper
{
    ...
    public function __construct(Array $map, $securityMode = 'escape')
    {
